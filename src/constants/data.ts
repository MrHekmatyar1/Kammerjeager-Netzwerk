export const PESTS_DATA = [
    ...
    { id: 'ratten', name: 'Ratten', img: '/pests/ratten.png' },
    { id: 'maeuse', name: 'Mäuse', img: '/pests/maeuse.png' },
    { id: 'schaben', name: 'Schaben', img: '/pests/schaben.png' },
    { id: 'ameisen', name: 'Ameisen', img: '/pests/ameisen.png' },
    { id: 'motten', name: 'Motten', img: '/pests/motten.png' },
    { id: 'flohe', name: 'Flöhe', img: '/pests/flohe.png' },
...
export const REVIEWS_DATA = [
    ...
    { id: 3, stars: 5, date: '08.01.2026', text: 'Pünktlich, sauber und sehr nett. Das Problem wurde umgehend analysiert und beseitigt. Kann ich nur jedem weiterempfehlen, der schnelle Hilfe braucht.' },
    { id: 4, stars: 5, date: '12.01.2026', text: 'Top Service! Schnelle Reaktion auf meine Anfrage und ein hervorragendes Ergebnis. Die Beratung war zudem sehr transparent und ehrlich.' },
    { id: 5, stars: 5, date: '15.01.2026', text: 'Wirklich professionell. Schnell, sauber, effektiv. Die Fachkraft war sehr höflich und hat alle meine Fragen geduldig beantwortet. Gerne wieder!' },
    { id: 6, stars: 5, date: '18.01.2026', text: 'Bester Kammerjäger in Berlin. Sehr diskret und effektiv bei der Bekämpfung. Man merkt sofort, dass hier Profis am Werk sind.' },
    { id: 7, stars: 5, date: '20.01.2026', text: 'Alles super gelaufen. Hatten ein massives Problem, jetzt ist alles weg. Die Nachsorge und Tipps waren ausgezeichnet. Vielen Dank!' },
    { id: 8, stars: 5, date: '22.01.2026', text: 'Preis-Leistung stimmt absolut. Ein sehr kompetenter Spezialist, der sein Handwerk versteht. Keine versteckten Kosten.' },
